					...
					<div class="profile-content">
							...
							<div class="col-md-9">
								<form enctype="multipart/form-data" action="#" method="POST">
									...
									<div class="add-avatar hidden">	<?php if(isset($errors['my-avatar']['empty'])) : ?>
									...
									<p class="email"><strong>E-mail :  </strong><?= $user['email'] ?> <button id="update-email" type="button" class="btn btn-secondary btn-sm">Modifier</button></p>
									<div class="add-email hidden">	<?php if(isset($error['new-email']['empty'])) : ?>
									...
									<p class="password"><strong>Mot-de-passe :  </strong><button id="update-password" type="button" class="btn btn-secondary btn-sm">Modifier mon mot-de-passe</button></p>
									<div class="add-password hidden">	<?php if(isset($error['new-password']['empty'])) : ?>
